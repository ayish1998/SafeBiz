...
def welcome_view(request):
    return HttpResponse("<h1>Welcome to the SentriBiz API</h1><p>This is the home page of the SentriBiz application.</p>")

urlpatterns = [
    path('', welcome_view, name='welcome'),  # Root URL that displays the welcome message
